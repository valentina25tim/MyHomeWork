...
//    const [modalPersonCard, setModalPersonCard] = useState(false)
   ...
   useEffect(() => {
    ...
    <div>
        ...
        уже готовый есть код, нужно перетянуть(см. кнопка Open в Vacancy List) */}
            <ButtonLookInfo>Look Info about Request</ButtonLookInfo>
            
            {/* NEED ToDo после нажатия загружается табличка по реквесту */}
            <ButtonLookResult>Look result</ButtonLookResult>
        ...
        <form className={classes.pp__form_table}>
        ...
        :
        <PersonList remove={removePerson} persons={sortedAndSearchedPersons}/>
        }
        </form>
